        ...
        <div class="container" style='Nunito', sans-serif;">
            ...
            <div class="column">
             ...
             <table class="table" aria-label="simple table">
                    ...
                    ${facture.items.map((itemField, index) => (
                        `<tr key="${index}" style="width: 600px;">
                            ...
                            <td type="text" style="margin-left: 5px; width: 100px;" name="montant" value="">
                                ${((itemField.qte * itemField.prix) * (1 - itemField.remisePourcent / 100) + (itemField.qte * itemField.prix) * itemField.tva / 100).toFixed(2)}
                            </td>
                        </tr>`
                    )).join('')}
                </tbody>
                ...
                <table>
                <tbody>
                <td><div style="font-size : 14px; margin-left :250px">Somme de remise en devise</div></td>
                <td><div style="font-size : 14px ; margin-right :400px">${facture.remiseParLignePourcent}</div></td>
                </table>
                ...
                End of invoice items loop --> 
                  <td>${facture.remiseParLignePourcent}</td>
                  <td>${facture.total}</td>
