        ...
        <div class="container" style='Nunito', sans-serif;">
            ...
            <div class="column">
             ...
             <table class="table" aria-label="simple table">
                    ...
                    ${facture.items.map((itemField, index) => (
                        `<tr key="${index}" style="width: 600px;">
                            ...
                            <td type="text" style="margin-left: 5px; width: 100px;" name="montantHT" value="" >
                                ${(itemField.montantHT2=itemField.qte*itemField.prix-itemField.remise).toFixed(2)}
                            </td>
                            <td type="text" style="margin-left: 5px; width: 100px;" name="montant" value="">
                                ${(itemField.montant2= (itemField.qte*itemField.prix)- itemField.remise +(itemField.qte*itemField.prix)*itemField.tva/100).toFixed(2)}
                            </td>
                        </tr>`
                    )).join('')}
                </tbody>
                ...
                <table>
                <tbody>
                <td><div style="font-size : 14px; margin-left :350px">Somme de remise </div></td>
                <td><div style="font-size : 14px ; margin-right :400px">${facture.totalRemise}</div></td>
                </table>
