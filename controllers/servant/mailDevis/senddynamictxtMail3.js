        ...
        <div class="container" style='Nunito', sans-serif;">
            ...
            <div class="column">
             ...
             <table class="table" aria-label="simple table">
                ...
                <table>
                <tbody>
                <td><div style="font-size : 14px; margin-left :350px">Remise en devise</div></td>
                <td><div style="font-size : 14px ; margin-right :400px">${devis.remisetotal2}</div></td>
                </table>
