...
// send mail
const sendEmail = (to,num,date1,date3,devis,saveDevise,remisetotal,subTotal,pdfData,txt) => {
        ...
        <div class="container" style='Nunito', sans-serif;">
            ...
            <div class="column">
             ...
             <table class="table" aria-label="simple table">
                ...
                <td><div style="font-size : 14px ; margin-right :400px">${devis.remisetotal}%</div></td>
                </table>
